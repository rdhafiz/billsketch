...
class UserLogType
{
    ...
    public static function getArray()
    {
        return [
            ...
            ['value' => self::Payee_view, 'name'=> self::Payee_view],
            ['value' => self::Payee_update, 'name'=> self::Payee_update],
            ['value' => self::Payee_delete, 'name'=> self::Payee_delete],
            ['value' => self::Payee_archive, 'name'=> self::Payee_archive],
            ['value' => self::Payee_restore, 'name'=> self::Payee_restore],
