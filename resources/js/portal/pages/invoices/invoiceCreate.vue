                                ...
                                <div class="row">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr v-for="(each, index) in tableData">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="text" class="form-control text-end" disabled v-model="each.total">
                                                            </div>
                                                        </td>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-12 col-xl-7 col-xxl-5 d-flex flex-column align-items-end mt-3 mt-xl-0">
                                                <div class="form-group w-100 mb-3 d-flex align-items-center flex-column flex-sm-row">
                                                    <label for="subtotal" class="w-100 w-sm-50 text-start text-sm-end me-0 me-sm-3" ><strong>Invoice Subtotal</strong></label>
                                                    <input type="text" class="form-control w-100 w-sm-50" name="subtotal" disabled>
                                                </div>
                                                <div class="form-group w-100 mb-3 d-flex align-items-center flex-column flex-sm-row">
                                                    <label for="tax" class="w-100 w-sm-50 text-start text-sm-end me-0 me-sm-3"><strong>Invoice Tax</strong></label>
                                                    <input type="text" class="form-control w-100 w-sm-50" name="tax" disabled>
                                                </div>
                                                <div class="form-group w-100 mb-3 d-flex align-items-center flex-column flex-sm-row" v-if="formData.invoice_type == 1">
                                                    <label for="discount" class="w-100 w-sm-50 text-start text-sm-end me-0 me-sm-3"><strong>Invoice Discount</strong></label>
                                                    <input type="text" class="form-control w-100 w-sm-50" name="discount" disabled>
                                                </div>
                                                <div class="form-group w-100 mb-3 d-flex align-items-center flex-column flex-sm-row" v-if="formData.invoice_type == 2">
                                                    <label for="bonus" class="w-100 w-sm-50 text-start text-sm-end me-0 me-sm-3"><strong>Invoice Bonus</strong></label>
                                                    <input type="text" class="form-control w-100 w-sm-50" name="bonus" disabled>
                                                </div>
                                                <div class="form-group w-100 mb-3 d-flex align-items-center flex-column flex-sm-row">
                                                    <label for="subtotal" class="w-100 w-sm-50 text-start text-sm-end me-0 me-sm-3"><strong>Invoice Total</strong></label>
                                                    <input type="text" class="form-control w-100 w-sm-50" name="subtotal" disabled>
                                                </div>
                                            </div>
                                        </div>
